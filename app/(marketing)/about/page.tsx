...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'About Dishyy - Food Party Planning Made Simple',
    description: 'Discover how Dishyy is revolutionizing food party planning.',
    images: ['/images/about-hero.jpg'],
  },
  alternates: {
    canonical: 'https://dishyy.com/about',
  },
};
...
export default function AboutPage() {
  ...
  const aboutPageSchema = {
    ...
    name: 'About Dishyy',
    description:
      "Learn about Dishyy's mission to revolutionize food party planning",
    url: 'https://dishyy.com/about',
    mainEntity: {
      '@type': 'Organization',
      name: 'Dishyy',
      description: 'A platform for organizing and coordinating food parties',
      foundingDate: '2024',
        ...
        <div className="relative overflow-hidden bg-background">
          ...
          <div className="relative text-center">
            ...
            <div className="mt-6 flex flex-col gap-6 text-lg leading-8 text-muted-foreground max-w-3xl mx-auto">
              ...
              <p>
                What started as a solution for a group of friends has grown into
                a platform that helps thousands of people create memorable food
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div className="space-y-8">
                ...
                <p className="text-lg text-muted-foreground">
                  ...
                  holiday feast, Dishyy provides the tools you need to
                  coordinate seamlessly with your friends and family.
                </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="group p-8 rounded-2xl bg-card/50 backdrop-blur-sm border shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-muted-foreground">
                  Create and manage your food parties with just a few clicks.
                  Our intuitive interface makes party planning a breeze.
                </p>
              </div>
              <div className="group p-8 rounded-2xl bg-card/50 backdrop-blur-sm border shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div className="rounded-full w-12 h-12 bg-primary/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
              ...
              <div className="group p-8 rounded-2xl bg-card/50 backdrop-blur-sm border shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-muted-foreground">
                  Focus on creating memories with your loved ones while we
                  handle the organizational details.
                </p>
              </div>
            </div>
          </div>
